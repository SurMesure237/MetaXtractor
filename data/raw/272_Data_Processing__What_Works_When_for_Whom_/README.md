...
Data processing scripts of the e-Mental Health project. The scripts deal with two data sets: OVK and Tactus. Data related to our paper "De-identification of Dutch Medical Text" can be found in the [data repository](https://github.com/e-mental-health/data)
